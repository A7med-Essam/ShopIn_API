...
namespace ShopIn_API.Migrations
{
    ...
    [Migration("20210923020513_edit-PromoCodes_v0.2")]
    partial class editPromoCodes_v02
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserPromoCode", b =>
                {
                    ...
                    b.HasKey("applicationUsersId", "promoCodesid");
            ...
            modelBuilder.Entity("ShopIn_API.Models.Products", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopIn_API.Models.PromoCode", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopIn_API.ViewModel.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ApplicationUserPromoCode", b =>
                {
                    b.HasOne("ShopIn_API.ViewModel.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("applicationUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShopIn_API.Models.PromoCode", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShopIn_API.Models.ProductRate", b =>
                {
                    b.HasOne("ShopIn_API.Models.Products", "Product")
